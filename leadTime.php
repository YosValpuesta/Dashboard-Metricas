...
echo json_encode($leadTimes); // Imprime los datos en formato JSON para ser utilizados por JavaScript
?>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <h1 class="text-center">Métrica LeadTime</h1>
                <br>
                <div class="container" style="width: 80%; height: 80%;">
                    <div>
                        <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
                        <canvas id="leadTimeChart" width="400" height="200" style="background-color: #c4dfe6;"></canvas>
                    </div>
                    ...
                    <script>
                        ...
                        const numerosHU = <?php echo json_encode(array_keys($leadTimes)); ?>; // Array de números de HU
